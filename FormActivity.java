...
public class FormActivity extends AppCompatActivity {
    ...
    private void saveStudent() {
        ...
        if (isEdit) {
            timestampFormatted = "Updated at " + currentTimestamp;
        } else {
            timestampFormatted = "Created at " + currentTimestamp;
        }

        student.setTimestamp(timestampFormatted);
        ...
        values.put(DatabaseContract.StudentColumns.TIMESTAMP, timestampFormatted);
